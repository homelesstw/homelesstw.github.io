...
import bgMask01 from "../public/img/bg-mask-1.png";
import bgMask03 from "../public/img/bg-mask-3.png";
import bgMask04 from "../public/img/bg-mask-4.png";
import bgMask05 from "../public/img/bg-mask-5.png";
import bgMask06 from "../public/img/bg-mask-6.png";
import bgMask07 from "../public/img/bg-mask-7.png";
...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-red-50">
      ...
      {/* 文字區 */}
      <main className=" z-40 inset-0 w-full min-h-screen">
        {/* 首段封面 */}

        <section className="w-full grid grid-cols-3 px-8">
        ...
        {/* 導言 */}
        <section className="w-full h-screen flex flex-colpx-8 items-center justify-center ">
        ...
        <section className="w-full h-screen p-8 flex flex-col">
        ...
        <section className="w-full h-screen p-8 flex flex-col">
          ...
          <div className="w-100 grid grid-cols-12 items-end">
            ...
            <div />
            <div className="col-span-5 h-auto my-4 p-8 bg-white">
              <p className="font-bold text-lg">社福單位不應該變成遊民製造機</p>
              <div className="text-sm mt-4">
                <p className="my-3 leading-normal">
                  10
      ...
      {/* 遮罩 */}
      <div className="absolute z-30 inset-0 w-full min-h-screen">
      ...
      {/* 底圖 */}
      <div className="absolute z-0 inset-0 w-full min-h-screen">
